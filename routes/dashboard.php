...
Route::get('activity', '\Vanguard\UserActivity\Http\Controllers\Web\ActivityController@index')->name('activity.index')
    ->middleware('permission:users.activity');

Route::get('activity/user/{user}/log', '\Vanguard\UserActivity\Http\Controllers\Web\UserActivityController@index')->name('activity.user')
    ->middleware('permission:users.activity');
