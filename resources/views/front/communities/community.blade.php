...
<header class="py-5">
    <div class="container px-lg-5">
        <div class="p-4 p-lg-5 bg-light rounded-3 text-center"
            style="background: url({{ asset('assets/content/community/'. $currentCommunity->first()->alias .'/profile.jpg') }}) 100% 100%">
            <div class="m-4 m-lg-5">
                <h1 class="display-5 fw-bold">{{ $currentCommunity->first()->name }}</h1>
            </div>
        </div>
    </div>
</header>
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="card mb-4">
                <a href="javascript:;"><img class="card-img-top"
                        src="{{ asset('assets/content/community/'. $currentCommunity->first()->alias .'/profile.jpg') }}"
                        alt="..." /></a>
                <div class="card-body">
                    ...
                    <div class="my-5">
                        ...
                        <div class="row" style="margin: 0px;">
                            ...
                            <div>
                                <h5>{{ $activity->name }}</h5>
                                <a
                                    href=" {{ url('community/'.$currentCommunity->first()->alias.'/'.$activity->alias) }} ">
                                    <img class="img-responsive img-portfolio img-hover card-img-top" src={{
                                        asset('content/community/'. $currentCommunity->first()->alias.
                        ...
                        <div class="row" style="margin: 0px;">
                            ...
                            <div>
                                ...
                                <a
                                    href=" {{ url('community/'.$currentCommunity->first()->alias.'/'.$activity->alias) }} ">
                                    <img class="img-responsive img-portfolio img-hover card-img-top" src={{
                                        url('assets/content/community/'. $currentCommunity->first()->alias.
        ...
        <div class="col-lg-4">
            ...
            <div class="card my-5">
                ...
                <div class="card-body">
                    <p><i class="fa fa-envelope"></i> <a href='mailto:{{ $currentCommunity->first()->email }}'
                            target="_top"> {{
                            $currentCommunity->first()->email }} </a></p>
                    <p><i class="fa fa-facebook"></i> <a href='{{ $currentCommunity->first()->fb_page }}' target="_top">
                            {{
                            $currentCommunity->first()->fb_page }} </a></p>
                    <p><i class="fa fa-globe"></i> <a href='{{ $currentCommunity->first()->website }}' target="_top"> {{
                            $currentCommunity->first()->website }} </a></p>
                </div>
            </div>
            ...
            <div class="card my-5 user-button">
                <div class="row">
                    ...
                    <input type="hidden" name="community_id" value="{{ $currentCommunity->first()->id }}">
