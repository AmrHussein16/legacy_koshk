            ...
            <div class="ibox float-e-margins">
                ...
                <div>
                    ...
                    <div class="ibox-content profile-content">
                        ...
                        <!--
                        <p><i class="fa fa-facebook"></i> <a href='{{ $currentCommunity->first()->fb_page }}' target="_top"> {{ $currentActivity->first()->eventlink }} </a></p>
                        <p><i class="fa fa-globe"></i> <a href='{{ $currentCommunity->first()->website }}' target="_top"> {{ $currentActivity->first()->website }} </a></p> -->
                        <h5>
                            Story
                        </h5>
                        <p>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="jumbotron">
                        ...
                        <h2>Comics Exhibition on Tour</h2>
                        <h3 style="color: #fcd116;">Malmö, <strong style="color: #005b99;">Sweden</strong></h3>
                        <p>Koshk Comics is calling all Comic Book artists to take part in the first Comic Stories exhibition of the “World War III”. The exhibition will go on an international tour starting this October. </p>
                        <p>First city destination is the Swedish cultural city of Malmö; In partnership with Historielabbet Handelsbolag, Kulturstråket Malmö, and the folkuniversitet Malmö/Lund.</p>
                        <h3><strong>Submission Deadline: 27-September-2017</strong></h3>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            {{ Form::open(array('url'=>'/community/'.$currentCommunity->first()->alias.'/'.$currentActivity->first()->alias,'files'=>true, 'class'=>'form-horizontal', 'name'=>$currentActivity->first()->alias)) }}
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Icon Image</label>
                                    ...
                                    <input name="currentCommunity" type="hidden" value="{{ $currentCommunity->first()->alias }}">
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Story</label>
                                    <div class="col-sm-10">
                                        <div class="input-group"><span class="input-group-btn"> <input id="Story" name="Story" type="file" accept=".zip" class="btn btn-primary">Select File
                                            ...
                                            – Zip File with the story pages (1 file/page). <br>
                                            – Page Size: Up to you </br>
                                            – Resolution: 300 dpi. </br>
                                            NOTE: The stories will be translated to English and Swedish, if you want to include your own translation add your translation to the Zip file in text format (a text/word file inside the zipped folder).</span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Submission Terms</label>
                                    <div class="col-sm-10">
                                        <p>By Submitting your work, you approve that Koshk Comics: </br>
                                        - print your work and exhibit them in World War III exhibitions in all/or some of the tour cities.</br>
                                        - publish your comic story on Mobile Apps and Website making them available for FREE.</br>
                                        - post web-resolution of the work for marketing on Koshk Comics website and Facebook page.</br>
                                        </p>
