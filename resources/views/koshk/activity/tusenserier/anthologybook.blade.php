...
@section('page-title', 'AltCom Festival - Anthology Book')
            ...
            <div class="ibox float-e-margins">
                ...
                <div>
                    ...
                    <div class="ibox-content profile-content">
                        ...
                        <p>
                            Koshk Comics is partnering with Tusen Serier to host a part of their "HOW TO SURVIVE A DICTATORSHIP!" book next August during the Altcom Festival in Malmo, Sweden.
                        </p>
                        <p>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="col-lg-12" style="padding-bottom: 30px;margin: -1px;">
                        <a href="{{ url('producer/tusenserier/anthologybook') }}">
                            <img class="img-responsive img-portfolio img-hover" src="https://www.koshkcomics.com/public/content/producer/tusenserier/activities/altcom/cover.jpg" alt="" style="margin-bottom: 0px;border-radius: 25px;">
                        </a>
                    </div>
                        ...
                        <h3><strong>Submission Deadline: 26-May-2018</strong></h3>
