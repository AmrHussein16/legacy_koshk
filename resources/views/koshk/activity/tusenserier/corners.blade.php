...
@section('page-title', 'CBA vol 43: Corners !')
            ...
            <div class="ibox float-e-margins">
                ...
                <div>
                    ...
                    <div class="ibox-content profile-content">
                        ...
                        <p>
                            Koshk Comics is partnering with Tusen Serier to host a part of their Corners call for submissions in Malmo, Sweden.
                        </p>
                        <p>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="col-lg-12" style="padding-bottom: 30px;margin: -1px;">
                        <a href="{{ url('producer/tusenserier/corners') }}">
                            <img class="img-responsive img-portfolio img-hover" src="https://www.koshkcomics.com/public/content/producer/tusenserier/activities/corners/cover.jpg" alt="" style="margin-bottom: 0px;border-radius: 25px;">
                        </a>
                    </div>


                        <h1>CBA vol 43: Corners!</h1>
                        <h2>CALL FOR ENTRIES</h2>
                        <h2>Corners!</h2>
                        <h3 style="color: #fcd116;">Malmö, <strong style="color: #005b99;">Sweden</strong></h3>
                        <p> I'll see you around the corner. Yeah, cool, but where exactly is that?
...
They host dust and spider webs, they might be grimy and smell like shit, but overall corners are meeting points. Literally the angle made when two ways intersect. But also where two feelings or two people collide. </p>
                        <p>More information will be found at <a href='https://www.facebook.com/events/286706412111284/' target="blank"> Event FB Page </a> </p>
                        <h3><strong>Submission Deadline: 1-November-2018</strong></h3>

                        <p></p>
                        
                        <p> <strong> Main editor:  </strong>  Gonzalo de las Heras</p>
...
For the next volume of CBA we invite you to dig into the concept of corners in whichever form you want to depict it. We're looking for both comics and texts.</br></br>
