...
<div class="wrapper wrapper-content">
            ...
            <div class="ibox float-e-margins">
                ...
                <div>
                    <div class="ibox-content no-padding border-left-right">
                        <img alt="image" class="img-responsive" src="{{ url('assets/content/community/'.$currentCommunity->first()->alias.'/activities/'.$currentActivity->first()->alias.'/profile.jpg') }}">
                    </div>
                                ...
                                <div class="row" style="margin-top: 25px;"> 
                                    <div class="col-lg-7">
                                        <div class="no-padding">
                                            <img alt="image" class="img-responsive" src="{{ url('assets/content/community/'.$currentCommunity->first()->alias.'/activities/'.$currentActivity->first()->alias.'/exhibition.jpg') }}" style="margin-bottom: 0px;border-radius: 25px;">
                                        </div>
                                    </div>
    ...
    <!--                                             <div class="stat-percent">48% <i class="fa fa-level-up text-navy"></i></div>
                                    ...
                                    <div class="col-lg-7">
                                        <div class="no-padding">
                                            <img alt="image" class="img-responsive" src="{{ url('assets/content/community/'.$currentCommunity->first()->alias.'/activities/'.$currentActivity->first()->alias.'/8oct.jpg') }}" style="margin-bottom: 0px;border-radius: 25px;">
                                        </div>
                                    </div>
                            ...
                            <div class="ibox-content" style="margin-top: 25px;">
                                <div class="row" style="margin-top: 25px;"> 
                                    <div class="col-lg-7">
                                        <div class="no-padding">
                                            <img alt="image" class="img-responsive" src="{{ url('assets/content/community/'.$currentCommunity->first()->alias.'/activities/'.$currentActivity->first()->alias.'/15oct.jpg') }}" style="margin-bottom: 0px;border-radius: 25px;">
                                        </div>
                                    </div>
    ...
    <!--                                             <div class="stat-percent">48% <i class="fa fa-level-up text-navy"></i></div>
                                    ...
                                    <div class="col-lg-7">
                                        <div class="no-padding">
                                            <img alt="image" class="img-responsive" src="{{ url('assets/content/community/'.$currentCommunity->first()->alias.'/activities/'.$currentActivity->first()->alias.'/18oct.jpg') }}" style="margin-bottom: 0px;border-radius: 25px;">
                                        </div>
                                    </div>
