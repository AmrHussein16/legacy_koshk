...
<div id="wrapper">
            ...
            <div id="page-wrapper" class="gray-bg" style="margin-left: 0px;margin-top: -100px;">
                ...
                <img src="assets/img/vanguard-logo.png" class="img-circle circle-border m-b-md" alt="profile" style="margin-top: 30px;margin-left: 100px;margin-bottom: -20px;">
                    ...
                    <div class="col-md-3">
                        ...
                        <a href="https://www.koshkcomics.org/public/login">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="text-left" style="margin-top: 55px;">
                            <a href="https://www.koshkcomics.org/public/register">
        ...
        <div class="row" style="margin: 15px;">
            ...
            <div class="col-md-6 col-sm-6" style="padding: 0px;margin: -1px;border-color: #fff;border-width: 2px;border-style: solid;">
                ...
                <div class="row">
                    <div>
                        <img src="assets/img/vanguard-logo.png" class="img-circle circle-border m-b-md" alt="profile" style="margin-left: 250px;">
                    </div>
                    <div class="p-m">
                        <h2 class="m-xs" style="text-align: center;">We're the comics online community</h2>

                        <h4 class="font-bold no-margins" style="text-align: center;">
                            Bring on Production and Art at one place!
                        </h4>
                        <h3 style="text-align: center;">Let's make more Stories!</h3>
                    </div>
                </div>
                <div class="row">
                     <div class="col-md-6">
            ...
            <div class="col-md-6 col-sm-6" style="padding: 0px;margin: -1px;border-color: #fff;border-width: 2px;border-style: solid;">
                <a href="comicbook?id=118">
                    <img class="img-responsive img-portfolio img-hover" src="content/home/koshkstart.jpg" alt="" style="margin-bottom: 0px;">
                </a>
            </div>
        </div>
