...
<!--         <div class="row">
            <div class="col-lg-12" style="margin-bottom: 15px;">  
                <div class="no-padding" style="background: {{  'url(' .'../assets/content/producer/'. $currentProducer->first()->alias. '/banner.jpg)' }} no-repeat;width: 100%;-webkit-background-size: 100%;">
    ...
    <!--
        <div class="col-md-12">
            <div class="no-padding img-responsive img-portfolio img-hover" style="background: {{ url('assets/content/producer/koshk/profile.jpg') }} no-repeat;width: 100%;-webkit-background-size: 100%;"> 
        </div> -->
    ...
    <div class="row animated fadeInRight" style="margin: 0px;">
            ...
            <div class="ibox float-e-margins">
                ...
                <div>
                    <div class="ibox-content no-padding border-left-right">
                        <img alt="image" class="img-responsive" src="{{ url('assets/content/producer/'.$currentProducer->first()->alias.'/profile.jpg') }}">
                    </div>
        ...
        <div class="ibox float-e-margins" style="margin-left: 10px;margin-bottom: 10px;">
            <img alt="image" class="img-responsive" src="{{ url('assets/content/producer/koshk/cover.jpg') }}">
        </div> -->
                        ...
                        @if ($activity->type == 'workshop')
                            ...
                            <div class="col-md-6 col-sm-6" style="padding: 5px;margin: -1px;border-color: #fff;border-width: 2px;border-style: solid;">
                                ...
                                <a href=" {{ url('producer/'.$currentProducer->first()->alias.'/'.$activity->alias) }} ">
                                    ...
                                    <img class="img-responsive img-portfolio img-hover" src= {{  url('assets/content/producer/'. $currentProducer->first()->alias. '/'.$activity->alias.'.jpg') }} alt="" style="margin-bottom: 0px;">
                                </a>
                            </div>
                        @endif 
                        ...
                        @if ($activity->type == 'challenge')
                            ...
                            <div class="col-md-6 col-sm-6" style="padding: 5px;margin: -1px;border-color: #fff;border-width: 2px;border-style: solid;">
                                ...
                                <a href=" {{ url('producer/'.$currentProducer->first()->alias.'/'.$activity->alias) }} ">
                                    ...
                                    <img class="img-responsive img-portfolio img-hover" src= {{  url('assets/content/producer/'. $currentProducer->first()->alias. '/activities/'.$activity->alias.'/profile.jpg') }} alt="" style="margin-bottom: 0px;">
                                </a>
                            </div>
                        @endif 
