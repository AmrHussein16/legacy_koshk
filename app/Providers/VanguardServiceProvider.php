...
class VanguardServiceProvider extends BaseVanguardServiceProvider
{
    ...
    protected function plugins()
    {
        return [
            ...
            // \Vanguard\Support\Plugins\Home::class,
            // \Vanguard\Support\Plugins\Community::class,
            // \Vanguard\Support\Plugins\Producer::class,
            ...
            \Vanguard\Support\Plugins\Announcements::class,
        ];
    }
