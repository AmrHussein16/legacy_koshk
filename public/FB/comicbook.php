<?php
    ...
    if (!$link = mysql_connect('localhost', 'hitsevey', 'TGfr4%6yh')) {
            ...
            //$sql    = 'SELECT * FROM `card` where category_id ='. $book .' ORDER BY card.id  DESC';
...
<body style="padding-top: 0px;">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <!-- <a href="comicbook.php?id=<?php echo $book;?>"> -->
                    <img class="img-responsive" src="http://koshkcomics.com/koshk_dev/assets/cards/<?php echo $book; ?>/iphone4/img.jpg" alt="" style="padding: 15px;border-style: solid;border-width: 1px;border-color: #eee;">
                <!--  </a> -->
            </div>
        </div>
        <!-- /.row -->
    ...
    <div class="container">
                ...
                <div class="ibox-content">
                    <div class="carousel slide" id="carousel1">
                        <div class="carousel-inner">
                            <div class="item">
                                <img alt="image" class="img-responsive" src="img-responsive" src="http://www.koshkcomics.com/koshk_dev/assets/cards/<?php echo $book;?>/<?php echo $data[$i]['id'];?>/large/featured.jpg">
                            </div>
        ...
        <div class="item gallery next left">
            <div class="row">
                <div class="col-sm-6">
                    <img alt="image" class="img-responsive" src="http://www.koshkcomics.com/koshk_dev/assets/cards/<?php echo $book;?>/<?php echo $data[$i]['id'];?>/large/featured.jpg">
                </div>
                <div class="col-sm-6">
                    <img alt="image" class="img-responsive" src="http://www.koshkcomics.com/koshk_dev/assets/cards/<?php echo $book;?>/<?php echo $data[$i]['id'];?>/large/featured.jpg">
                </div>
                ...
                <ul class="grid list-inline list-unstyled cs-style-1">
                    ...
                    <li>
                        ...
                        <figure>
                            ...
                            <img src="http://www.koshkcomics.com/koshk_dev/assets/cards/<?php echo $book;?>/<?php echo $data[$i]['id'];?>/large/featured.jpg" alt="artwork">
                            ...
                            <figcaption style="background: rgba(255,255,255,0.6);">
                                <a class="story_link" href="story.php?book=<?php echo $book;?>&id=<?php echo $data[$i]['id'];?>">
